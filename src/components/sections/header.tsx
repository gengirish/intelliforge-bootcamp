      ...
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:block">
          <a
            ...
            className="inline-flex items-center justify-center gap-2 rounded-lg bg-cta px-4 py-2 text-sm font-medium text-background hover:bg-cta-hover transition-colors"
          >
