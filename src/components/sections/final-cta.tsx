...
export function FinalCTA() {
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_50%_at_50%_50%,rgba(124,58,237,0.1),transparent_70%)]"
        aria-hidden
      />
      ...
      <FadeIn className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        <a
          ...
          className={cn(
            "mt-10 inline-flex items-center justify-center gap-3 rounded-xl bg-cta px-10 py-5 text-lg font-semibold text-background",
